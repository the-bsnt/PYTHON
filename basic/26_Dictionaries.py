...
#    A dictionary is a collection which is ordered* (after python version 3.7)
...
#    print(car["age"])   # KeyError: 'age'

#    so if we use .get("key") method we get none if key doesnt exist in dictionary

print(car.get("age"))  # it returns 'none'

#    if key doesnt exist in dictionary, we can also use
#    get method to return default value

print(car.get("vintage", "yeah!"))  # if 'vintage' doesnt exits as key,
# it returns 'yeah!' by default.
